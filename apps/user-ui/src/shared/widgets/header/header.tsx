    ...
    return (
        <div className="w-full bg-white">
            <div className="w-[80%] py-5 m-auto flex items-center justify-between">
                <div>
                    <Link href={"/"} />
                    <span className="text-2xl font-[600]">Cherrybrush</span>
                </div>
                ...
                <div className="flex items-center gap-8">
                    ...
                    <div className="flex items-center gap-5">
                        <Link href={"/wishlist"} className="relative">
                            <Image src={heart} alt="Wishlist" width={26} height={26} />
                            <div className="w-6 h-6 border-2 border-white bg-red-500 flex items-center justify-center rounded-full absolute top-[-10px] right-[-10px]">
