    ...
    <div className="w-full min-h-screen p-8">
      ...
      <div className="mt-8 bg-gray-900 p-6 rounded-lg shadow-lg ">
        ...
        {!isLoading && discountCodes?.length === 0 && (
          <p className="text-gray-400 w-full text-center pt-4 block">
            {' '}
              ...
              <div className="mt-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      {...field}
                      className="w-full py-2 px-2 border outline-none border-gray-700 bg-transparent text-white"
                    >
      ...
      {selectedDiscount && showDeleteModal && (
