          ...
          <>
            {!showOtp ? (
                ...
                <div className="relative">
                  <input
                    ...
                    {...register('phone_number', {
                      ...
                      maxLength: {
                        value: 15,
                        message: 'Phone number must be not exceed 15 digits',
                      },
                    })}
                  ></input>
                  {errors.phone_number && (
              ...
              <div>
                ...
                <button
                  className="w-full mt-8 text-lg cursor-pointer bg-blue-500 text-white py-2 rounded-lg"
